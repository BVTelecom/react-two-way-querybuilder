...
var Rule = function (_React$Component) {
  ...
  function Rule(props) {
    ...
    var field = _this.getFieldByName(_this.node.field);
    _this.state = {
      currField: _this.generateRuleObject(field, _this.node),
    ...
    value: function getInputTag(inputType) {
      ...
      switch (inputType) {
        ...
        case 'select':
          return _react2.default.createElement(
            'select',
            { value: this.node.value, className: this.styles.select, onChange: this.onInputChanged },
